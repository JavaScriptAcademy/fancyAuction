...
function loadItem(){
  var items = [
  {
    ...
    initPrice: 200,
    startTime: new Date("4 10,2016 20:00:00"),
    endTime: new Date("4 10,2016 22:00:00"),
  ...
  },
  {
    name: 'Big Eye Babi',
    initPrice: 500,
    startTime: new Date("4 11,2016 11:00:00"),
    endTime: new Date("4 11,2016 12:00:00"),
  ...
  },
   {
    name: 'Wedding Babi',
    initPrice: 500,
    startTime: new Date("4 11,2016 12:00:00"),
    endTime: new Date("4 11,2016 14:00:00"),
  ...
  },
  {
    name: 'Princess Babi',
    initPrice: 500,
    startTime: new Date("4 12,2016 11:00:00"),
    endTime: new Date("4 12,2016 12:00:00"),
  ...
  },
  {
    name: 'Chinese Babi',
    initPrice: 500,
    startTime: new Date("4 12,2016 14:00:00"),
    endTime: new Date("4 12,2016 16:00:00"),
  ...
  },
  {
    ...
    initPrice: 500,
    startTime: new Date("4 12,2016 16:00:00"),
    endTime: new Date("4 12,2016 18:00:00"),
  ...
  },
   {
    ...
    initPrice: 5000,
    startTime: new Date("4 12,2016 18:00:00"),
    endTime: new Date("4 12,2016 20:00:00"),
  ...
  },
  {
    ...
    initPrice: 5000,
    startTime: new Date("4 12,2016 20:00:00"),
    endTime: new Date("4 12,2016 22:00:00"),
